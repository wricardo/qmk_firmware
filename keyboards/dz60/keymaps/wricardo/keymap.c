...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_LCTL,       LT(1, KC_A),    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
	...
	LAYOUT(
		...
		KC_TRNS,       KC_PGUP, KC_UP,   KC_PGDN, KC_HOME, KC_TRNS,LSFT(KC_8),LSFT(KC_MINUS),LSFT(KC_EQL), LSFT(KC_5), LSFT(KC_BSLS), LSFT(KC_1), LSFT(KC_2), KC_DEL,
		KC_TRNS,       KC_LEFT, KC_DOWN, KC_RGHT,KC_END,KC_TRNS,LSFT(KC_6),LSFT(KC_9),LSFT(KC_0),LSFT(KC_7),KC_GRV, SENDSEMICOLEQ, KC_TRNS,
		KC_TRNS,       KC_TRNS, KC_VOLD, KC_VOLU, KC_MPRV, KC_MNXT, KC_MPLY, LSFT(KC_4),KC_MINUS,KC_EQL,LSFT(KC_GRV), KC_MUTE, KC_TRNS, KC_TRNS,
